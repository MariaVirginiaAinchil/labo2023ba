...
PARAM <- list()
PARAM$experimento <- "TS6410_008_3msotros"

PARAM$exp_input <- "FE6310_008_3ms"
...
PARAM$train$training <- c(
  202012, 202011, 202010, 202009, 202008, 202002, 202001,
  201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902
)

PARAM$train$validation <- c(202012)
PARAM$train$testing <- c(202101, 202103, 202105)
...
PARAM$train$semilla <- 100207 # semilla  acordada con Jesus
