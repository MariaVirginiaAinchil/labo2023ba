...
PARAM <- list()
PARAM$experimento <- "TS6410_008_exp13"

PARAM$exp_input <- "FE6310_008_exp13"
...
PARAM$train$testing <- c(202106, 202104, 202102)
...
PARAM$train$semilla <- 143821 # semilla  acordada con Jesus
