...
PARAM <- list()
PARAM$experimento <- "FE6310_008_exp13"

PARAM$exp_input <- "DR6210_008_exp13"
...
PARAM$RandomForest$semilla <- 143821 #  semilla 1 elegida con Jesus
...
# semilla 1 elegida con Jesus
PARAM$CanaritosAsesinos$semilla <- 143821
