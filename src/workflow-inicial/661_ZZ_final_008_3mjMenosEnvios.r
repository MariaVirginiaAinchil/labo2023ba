...
PARAM <- list()
PARAM$experimento <- "ZZ6610_008_2mjMenosEnvios"
PARAM$exp_input <- "HT6510_008_2mj"
...
# 5 semillas acordadas con Jesus
PARAM$semillas <- c(100207, 101009,  200003, 280001, 300007)

PARAM$kaggle$envios_desde <- 6000L
PARAM$kaggle$envios_hasta <- 9000L
