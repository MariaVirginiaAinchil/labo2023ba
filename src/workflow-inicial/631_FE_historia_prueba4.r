...
PARAM <- list()
PARAM$experimento <- "FE6310_prueba4"

PARAM$exp_input <- "DR6210_prueba4"
...
PARAM$RandomForest$semilla <- 100207 #  propia semilla


# varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$ratio <- 0.5
# desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$desvios <- 10
# cambiar por la propia semilla
PARAM$CanaritosAsesinos$semilla <- 101009
